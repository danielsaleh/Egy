    ...
    * OwlSlider
    ...
    e.Owl = function () {
      ...
      if(owlslider.length > 0) {
         loadScript(plugin_track + 'owl-carousel/dist/owl.carousel.min.js', function() {
           owlslider.each(function () {
            var $this = $(this),
                ...
                $(this).owlCarousel({
                    ...
                    margin:$space,
                    nav: $navarrow,
                    navText:["<i class='arr ti-arrow-left'></i>","<i class='arr ti-arrow-right'></i>"],
                    autoplay: $autoplay,
    ...
    e.Gallery = function() {
    	if ($(".lightbox-gallery").exists() || $(".popup-youtube, .popup-vimeo, .popup-gmaps").exists()){
    		loadScript(plugin_track + 'magnific/dist/jquery.magnific-popup.min.js', function() {
